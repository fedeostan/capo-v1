...
- Profile: company details, the manager's account, the crew (including who is reachable by the morning SMS and how loaded they are), the language (including the option to translate all existing data into it, and to undo that), the subscription, install, and sign out.
