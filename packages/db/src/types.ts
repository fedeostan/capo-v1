...
//
// Fully in sync with the live project as of 2026-07-27: 0015 and 0016 are
// applied (versions 20260727115633 / 20260727115702), and regenerating was
// verified to reproduce this file — the hand-written blocks for
// translation_batches, translation_items, revert_translation_batch,
// notification_log, lisbon_hour and workers.language all matched.
export type Json =
  | string
  | number
  | boolean
