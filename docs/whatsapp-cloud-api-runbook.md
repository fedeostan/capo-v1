...
| `capo_message_waiting` | `message_worker`, when the crew member's 24h window is shut | §6f; the window-reopener. ⚠ **submitted 31 Aug 2026 and approval NOT confirmed** |
