  ...
  if (params.enviado) {
    return (
      <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center gap-6 px-6 pb-16 text-center">
        ...
        <h1 className="text-2xl font-semibold">{t.auth.recover.sentTitle}</h1>
        <p className="text-sm text-zinc-500">{t.auth.recover.sentText}</p>
  ...
  return (
    <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center gap-6 px-6 pb-16">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-zinc-500">{t.auth.recover.subtitle}</p>
      </div>
